...
/// 版本检测
/// @param appleId App Store Id
/// @param promptType 版本检测提示用户交互类型 default 一直会做检测
/// @param cycle 版本检测下一次提示周期(单位/天) default 7
/// @param isShowUpdateContent 是否显示更新日志内容 default NO
